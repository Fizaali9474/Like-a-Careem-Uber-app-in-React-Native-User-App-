  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input}
        placeholder="Select Your Destination Location Here"
      ...
      <Button title="vehicles" onPress={() => navigation.navigate
        ("vehicleSelection",{pickup,destination})} />
      <Text>Go To Vehicles..</Text>
    </View>
  );
}
